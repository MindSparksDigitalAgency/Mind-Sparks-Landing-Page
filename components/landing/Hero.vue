  ...
  <main class="grid lg:grid-cols-2 place-items-center pt-16 pb-8 md:pt-8">
    ...
    <div>
      <h1 class="text-5xl lg:text-6xl xl:text-7xl font-bold lg:tracking-tight">
        Mind Sparks: Where Ideas Ignite Innovation
      </h1>
      <p class="text-lg mt-4 text-slate-600 max-w-xl">
        At Mind Sparks, we believe in turning visionary ideas into impactful realities. <wbr> Discover our unique approach to creativity, strategy, and success. Let’s spark something amazing together.
      </p>
